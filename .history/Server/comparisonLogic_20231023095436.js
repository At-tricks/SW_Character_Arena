...
function compareAttributes(character1, character2) { //modify
    ...
    for (const attribute in attributeComparisonConfig) {
        ...
        const value1 = getNestedAttribute(character1, attribute); // modify
        const value2 = getNestedAttribute(character2, attribute); // modify
