...
function convertAttributesToInt(character) {
    ...
    // Convert diameter attribute of homeWorld to an integer
    character.homeWorld.diameter = parseInt(character.homeWorld.diameter);

    // Convert lifeSpan attribute of species to an integer
    character.species.lifeSpan = parseInt(character.species.lifeSpan);

    // Convert cargoCapacity attribute of vehicle to an integer
    character.vehicle.cargoCapacity = parseInt(character.vehicle.cargoCapacity);
